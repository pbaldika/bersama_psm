...
<section id="hero-animated" class="hero-animated d-flex align-items-center">
    ...
    <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative" data-aos="zoom-out">
      ...
      <p>Mari bekerja sama dengan Bersama untuk menumbuhkan investasi kalian dengan cara Islami. Tanpa Riba dan Kerugian.</p>

      <a href="{{route('register')}}" class="btn-get-started scrollto">Mulai Berinvestasi</a>
    </div>
</section>
...
<section id="services" class="services d-flex">
      <div class="container" data-aos="fade-up">
        ...
        <div class="justify-content-center align-items-center text-center">
          <div>
            <a href="{{route('investment-list')}}" class="btn btn-info">Lebih Banyak Lagi</a>
          </div>
        </div>
